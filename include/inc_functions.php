...
function checkEmpty($fullName, $email, $userName, $password, $repassword)
...
function invalidUsername($userName, $fullName)

//Checks if the user entered valid characters//
...
//checks if the entered mail is a valid email id//
...
// this function compares password and re entered password
...
function userexists($conn, $userName, $email)
{
    ...
    //this function checks if the given user name already exists//
    ...
    if ($row = mysqli_fetch_assoc($retdata)) {
        ...
        //if the query returns data then that means user exists//
...
function createUser($conn, $userName, $email, $fullName, $password)
{
    
    //this function creates the user and adds it to the database//
...
function validateLogin($password, $conn, $username)
{   //function for validating login. It calls the userexists function and then vaerifies passwords//
...
//starts the session and stores the required session variables//
...
function cnclBkng($conn, $bid)

    //function to cancel previous booking. selects the booking using the booking id from the session and deletes the matching entry from the database//
{
    $id = $_SESSION['bid'];
...
//checks if the admin by the provided name exists or not//
...
function validateAdminLogin($password, $conn, $username)

//validates the admin login. Sinilar to the validate login function. But, uses data from the admin table//
...
//this set of functions are for updating user information. All functions are similar to the ones used when creating new user//

function edit_checkEmpty($new_fullname, $new_username)
{
